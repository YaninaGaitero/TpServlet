...
public class CrearUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<body>\n"
                    + "<div class=\"container\">\n"
                    + "	<section id=\"content\">\n"
                    + "		<form action=\"CrearUser\" name=\"AltaUser\" method=\"POST\">\n"
                    + "			<div>\n"
                    + "                <input placeholder=\"Nombre\" required=\"\" name=\"Nombre\" type=\"text\" >\n"
                    + "            </div>\n"
                    + "\n"
                    + "            <div>\n"
                    + "                <input placeholder=\"Apellido\" required=\"\" name=\"Apellido\" type=\"text\">\n"
                    + "            </div>\n"
                    + "\n"
                    + "            <div>\n"
                    + "                <input placeholder=\"DNI\" required=\"\" name=\"DNI\" type=\"text\">\n"
                    + "            </div>\n"
                    + "\n"
                    + "            <div>\n"
                    + "				<input placeholder=\"Usuario\" required=\"\" name=\"Username\" type=\"text\">\n"
                    + "			</div>\n"
                    + "			<div>\n"
                    + "				<input placeholder=\"Contraseña\" required=\"\" name=\"password\" type=\"password\">\n"
                    + "			</div>\n"
                    + "			<center><div>\n"
                    + "            <div>\n"
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Usuario AltaUser = new Usuario();

            AltaUser.setApellido(request.getParameter("Apellido"));
            AltaUser.setContraseña(request.getParameter("password"));
            AltaUser.setDni(Integer.parseInt(request.getParameter("DNI")));
